...
def create_config(
    ...
    *,
    ...
    raw: dict[str, Any] = {
        ...
        "ecc_template": {
            "anchor_selection": "first_unicode_path",
            "minimum_successful_references": 16,
            "support_mask": "intersection",
            "support_erosion_kernel_size": 5,
            "support_erosion_iterations": 1,
            "support_erosion_border": "constant_zero",
            "minimum_support_fraction": 0.75,
            "aggregation": "pixelwise_median_valid_values",
        },
        "ecc_residual_scoring": {
            "validity_erosion_kernel_size": 5,
            "validity_erosion_iterations": 1,
            "validity_erosion_border": "constant_zero",
            "minimum_effective_support_fraction": 0.95,
            "residual": "absolute_grayscale",
            "gaussian_kernel_size": 5,
            "gaussian_sigma": 0.0,
            "gaussian_border": "constant_zero",
            "top_fraction": 0.01,
        ...
        "patch_hog": {
            ...
            "vertical_positions": 15,
            "horizontal_positions": 15,
            "patch_count": 225,
            "ordering": "row_major",
            "orientations": 9,
            "pixels_per_cell_height": 16,
            "pixels_per_cell_width": 16,
            "cells_per_block_height": 2,
            "cells_per_block_width": 2,
            "block_norm": "L2-Hys",
            "transform_sqrt": True,
            "visualize": False,
            "feature_vector": True,
        ...
        "latency_measurement": {
            "boundary": "decoded_grayscale_uint8_to_image_score",
            "timer": "perf_counter_ns",
            "warmup_passes": 1,
            "timed_passes": 3,
            "path_order": "unicode_code_point_ascending",
            "summary_sample": "all_images_all_timed_passes",
            "median_rule": "mean_of_middle_pair_when_even",
            "p95_quantile": 0.95,
            "p95_rule": "nearest_rank",
            "include_failed_score_timings": True,
            "duration_unit": "nanoseconds",
        },
        "failure_case_selection": {
            "max_cases_per_type": 5,
            "false_positive_order": "anomaly_score_descending",
            "false_negative_order": "anomaly_score_ascending",
            "tie_breaker": "relative_path_ascending",
            "image_access": False,
        },
        "hard_gate_decision": {
            "gate_order": [
            ...
            "normal_fpr_max": 0.05,
            "anomaly_recall_min": 0.90,
            "cpu_p95_latency_seconds_max": 1.0,
            "normal_reference_count_max": 20,
